...
class VolumeControl : WaveformGenerator {
    ...
    override fun link(linkType: String, generator: WaveformGenerator) {
        when {
            linkType.lowercase(Locale.getDefault()) == "volume" -> this.volumeFunction = generator
            linkType.lowercase(Locale.getDefault()) == "waveform" -> this.waveformFunction = generator
